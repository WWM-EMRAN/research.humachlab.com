...
(function() {
  ...
  function setMobileNavState(open) {
    ...
    mobileNavToggleBtn.setAttribute('aria-label', open ? 'Close mobile navigation' : 'Open mobile navigation');
  }
  ...
  /**
   * Hide mobile nav on final navigation links. Dropdown arrow clicks are handled separately.
   */
  document.querySelectorAll('#navmenu a').forEach(navmenu => {
    navmenu.addEventListener('click', (event) => {
      if (event.target && event.target.closest('.toggle-dropdown')) return;
  ...
  document.querySelectorAll('.navmenu .toggle-dropdown').forEach(navmenu => {
    navmenu.addEventListener('click', function(e) {
      ...
      parentLink.setAttribute('aria-expanded', submenu.classList.contains('dropdown-active') ? 'true' : 'false');
    });
  });
